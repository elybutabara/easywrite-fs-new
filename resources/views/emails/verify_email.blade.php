...
<head>
    ...
    <style type="text/css" rel="stylesheet" media="all">
        ...
        .button-success {
            ...
            background-color: #3869D4; border-radius: 3px; color: #ffffff !important; font-size: 15px; line-height: 25px;
            text-align: center; text-decoration: none; -webkit-text-size-adjust: none;
            font-family:Helvetica Neue, Helvetica, sans-serif;background-color: #22BC66;
        }
    </style>
</head>
                                ...
                                <tr>
                                    <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}" class="p-container">
                                        ...
                                        @php
                                            ...
                                            $replace = [
                                                $user->first_name,
                                                "<a href='".$verificationUrl."' class='button-success' target='_blank'>",
                                                "</a>",
