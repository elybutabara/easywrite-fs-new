                                        ...
                                        <div class="row testimonial-details-row">
                                            ...
                                            <div class="user-details">
                                                <div class="images-container">
                                                    <img data-src="https://www.easywrite.se/{{ $testimonial->author_image }}" class="user-image"
                                                    alt="user icon">
                                                    <img data-src="https://www.easywrite.se/{{ $testimonial->book_image }}" class="book-image"
                                                    alt="book icon">
                                                </div>
                                                <div class="user-info">
                                                    <span class="font-montserrat-semibold theme-text">{{ $testimonial->name }}</span>
