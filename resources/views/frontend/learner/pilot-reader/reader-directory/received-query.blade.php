...
@section('title')
    <title>Received Queries &rsaquo; Easywrite</title>
@stop
        ...
        <div class="col-sm-12 col-md-10 sub-right-content reader-directory-search white-background">
            <div class="col-sm-12">
                <div class="col-md-8 col-sm-offset-2 col-sm-12 margin-top">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title with-border-b pb-2">Received Queries</h4>
                            <table id="received-queries-table" class="table table-striped table-bordered" width="100%">
                                <thead>
                                <tr>
                                    <th>To</th>
                                    <th>Book</th>
